...
using MedicalClinic.Application.Security;
using MedicalClinic.Domain.Common.Information;
using MedicalClinic.Infrastructure.Security;
using MedicalClinic.Persistence.Security;
    ...
    public class Startup : SpinStartup
    {
        ...
        public override void ConfigureServices(IServiceCollection services)
        {
            services.AddSwaggerGen(options =>
            {
                ...
                {
                    Title = $"Medical Security {groupName}",
                    Version = groupName,
                    Description = "Medical API Security information, made by medical developer team",
