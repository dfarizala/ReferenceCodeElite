...
using MedicalClinic.Application.Pharmacy;
using MedicalClinic.Domain.Pharmacy.Entities.Information;
using MedicalClinic.Infrastructure.Pharmacy;
using MedicalClinic.Persistence.Pharmacy;
...
using Spin.MedicalClinic.Pharmacy;
...
namespace Spin.WebSite
{
    public class Startup : SpinStartup
    {
        ...
        public Startup(IConfiguration configuration)
            : base(configuration, new ClinicalPharmacyInformation())
        {
        ...
        public override void ConfigureServices(IServiceCollection services)
        {
            services.AddSwaggerGen(options =>
            {
                ...
                {
                    Title = $"Medical Pharmacy {groupName}",
                    Version = groupName,
                    Description = "Medical API Pharmacy information, made by medical developer team",
