using System;
using MediatR;
using MedicalClinic.Domain.Invoice.CQRS.Commands.Response;
namespace MedicalClinic.Domain.Invoice.CQRS.Commands.Request
{
    /// <summary>
    /// Request for Single Invoice Command
    /// </summary>
    public class RequestSingleInvoiceCommand : IRequest<ResponseSingleInvoiceCommand>
    {
        /// <summary>
        /// Account Number
        /// </summary>
    ...
    /// <summary>
    /// Request for Multiple Invoice Command
    /// </summary>
    public class RequestMultipleInvoiceCommand : IRequest<ResponseMultipleInvoiceCommand>
    {
        /// <summary>
        /// Patient ID
        /// </summary>
    ...
    /// </summary>
    public class RequestCreateAccountCommand : IRequest<ResponseCreateAccountCommand>
    {
        /// <summary>
