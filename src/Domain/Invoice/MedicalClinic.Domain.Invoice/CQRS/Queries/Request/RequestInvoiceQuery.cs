...
namespace MedicalClinic.Domain.Invoice.CQRS.Queries.Request
{
    ...
    /// Request Login Query
    /// </summary>
    public class RequestSingleInvoiceQuery : IRequest<ResponseSingleInvoiceQuery>
    {
        /// <summary>
        /// Account Number
        /// </summary>
    ...
    /// <summary>
    /// Request Multiple Invoices Query
    /// </summary>
    public class RequestMultipleInvoiceQuery : IRequest<ResponseMultipleInvoiceQuery>
    {
        /// <summary>
        /// Patient ID
        /// </summary>
    ...
    /// <summary>
    /// Request Create Account Query
    /// </summary>
    public class RequestCreateAccountQuery : IRequest<ResponseCreateAccountQuery>
    {
        /// <summary>
